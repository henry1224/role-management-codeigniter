        ...
        <div class="col-lg-12">
            ...
            <div class="ibox shadow">
                <div class="ibox-title">
                    <a class="btn btn-outline btn-primary shadow" href="<?= base_url('inventori/browse') ?>">Browse</a>
                </div>
                    ...
                    <div class="container" id="pwd-containter1">
                        <form class="form-horizontalcenter" method="POST" action="">
                            ...
                            <div class="form-group row"><label class="col-sm-2 col-form-label">Kode</label>
                                <div class="col-md-8"><input type="text" name="kode_inventori" class="form-control" autocomplete="off" autofocus>
                            ...
                            <div class="form-group row"><label class="col-sm-2 col-form-label">Nama</label>
                                <div class="col-md-8"><input type="text" name="nama_inventori" class="form-control" autocomplete="off" autofocus>
                                </div>
                            </div>
                            <div class="form-group row"><label class="col-sm-2 col-form-label">Type</label>
                                <div class="col-sm-8"><input type="text" name="type_inventori" class="form-control" autocomplete="off">
                            ...
                            <div class="form-group row"><label class="col-sm-2 col-form-label">Pola</label>
                                <div class="col-sm-8"><input type="text" name="pola_inventori" class="form-control" autocomplete="off">
                                </div>
                            </div>
                                ...
                                <div class="col-md-8">
                                    <select class="form-control select2" name="id_segment">
                                        ...
                                        <?php foreach ($segment as $tampil) { ?>
                                            <option value="<?php echo $tampil->id_segment; ?>"><?php echo $tampil->nama_segment; ?></option>
                                        <?php } ?>
                                    </select>
                            ...
                            <div class="form-group row"><label class="col-sm-2 col-form-label">Harga Beli</label>
                                <div class="col-md-8"><input type="number" name="harga_beli" class="form-control" autocomplete="off" autofocus></div>
                            </div>
                            <div class="form-group row"><label class="col-sm-2 col-form-label">Harga Jual</label>
                                <div class="col-md-8"><input type="number" name="harga_jual" class="form-control" autocomplete="off" autofocus></div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group row"><label class="col-sm-1 col-form-label">By</label>
                                        <div class="col-md-8"><input type="text" name="create_by" class="form-control" autocomplete="off" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group row"><label class="col-sm-1 col-form-label">Last</label>
                                        <div class="col-md-8"><input type="text" name="create_date" class="form-control" autocomplete="off" readonly></div>
                                    </div>
                                </div>
                            </div>
                        </form>
